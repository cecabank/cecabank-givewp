...
class Client
{
    ...
    private $o_required = array(); // array('Environment', 'ClaveCifrado', 'MerchantID', 'AcquirerBIN', 'TerminalID', 'TipoMoneda', 'Exponente', 'Cifrado', 'Pago_soportado');
    private $o_optional = array('Environment', 'ClaveCifrado', 'MerchantID', 'AcquirerBIN', 'TerminalID', 'TipoMoneda', 'Exponente', 'Cifrado', 'Pago_soportado', 'Idioma', 'Descripcion', 'URL_OK', 'URL_NOK', 'Tipo_operacion', 'Datos_operaciones', 'PAN', 'Caducidad', 'CVV2', 'Pago_elegido', 'versionMod');
    ...
    {
        // Base64-decoded merchant key is the 24-byte 3DES key.
        $key3des = base64_decode($claveComercio);

        // 3DES-CBC of the operation number with manual zero padding to a
        // multiple of 8 bytes and a fixed zero IV. The output is the binary
        // key used by HMAC-SHA256.
        $blockSize = 8;
